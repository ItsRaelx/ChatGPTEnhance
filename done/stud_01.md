...
Materiały
Z uwagi na
bardzo duży walor merytoryczny i dydaktyczny, do
...
Złożoność obliczeniowa algorytmu
Obserwacja:
Miara szybkości algorytmu powinna być niezależna od
języka
...
• Częstotliwość wykonania zależy od algorytmu,
danych wejściowych.
...
1. przejazdu między wszystkimi miastami jest
n!.
...
2. Nie istnieje algorytm wielomianowy dla problemu komiwojażera.
3. Problem komiwojażera jest problemem obliczeniowo trudnym.
...
tylko jeden krążek**
2. W żadnym
momencie większy krążek nie może być
umieszczony na krążku mniejszym.
---
Rozwiązanie:
...
---
Rekurencja
1. dodawanie( wszystkich liczb naturalnych o wartości < n
>1) = dodawanie ( wszystkich liczb naturalnych o wartości < n-1)  + n
2. Silnia( n )
= n*( silnia o wartości < n-1)
